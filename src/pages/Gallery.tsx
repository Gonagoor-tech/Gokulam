...
const GalleryPage = () => {
  ...
  const images = [
    ...
    },
    {
      ...
      description: "GURU VIDWAN SHRI H S VENUGOPAL SIR BEING FELICITATED BY PADMA BHUSHAN AWARDEE & RAJYA SABHA MP DR SUDHA MURTHY AT GOKHALE INSTITUTE OF PUBLIC AFFAIRS, DURING THE KAVYA VACHANA, VADANA - VACHANA - VYAKHYAYANA PROGRAM"
    },
    {
